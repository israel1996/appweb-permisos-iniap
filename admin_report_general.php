...
<body>
  ...
  <!-- Modal PDF -->
  <div class="modal fade" id="modalReportGeneral" tabindex="-1" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <iframe id="pdfFrameGeneral" src="" width="100%" height="500px"></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-auto">
      <button class="btn btn-dark text-white" id="btnReportGeneral" style="margin-top:-2px"> Generar PDF </button>
      </div>
      <div class="col-auto">
  ...
  <script>
    ...
    function getData() {
      ...
      let url = "./partials/tableReportGeneral.php";
