...
<div class="row">
    ...
    <div class="col-11">
        <select id="searchEmployeeDiscountDay" class="form-select" style="width: 100%;">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#searchEmployeeDiscountDay').select2();

        $('#searchEmployeeDiscountDay').change(function () {
            var idEmployee = $(this).val();
           $('#idEmployee_discountDay').val(idEmployee);
           getData("discountDay");
