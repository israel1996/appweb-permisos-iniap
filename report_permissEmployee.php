...
class PDF extends FPDF
{
    ...
    function Content1($data)
    {
        ...
        $this->SetFont('Arial', 'B', 10);
        $this->Cell(60, 5, $data['balanceWorkingDays_permission'].' dias laborables y '. $data['balanceWeekendDays_permission'] .' fines de semana', 0, 1); // Aumente el ancho de la celda a 40 para dar más espacio para la fecha
